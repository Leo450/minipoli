...
$args = apply_filters( 'woocommerce_single_product_quantity', $args );
...
if ( $max_value && $min_value === $max_value ) {
	...
	<?php if(isset($args['_cmd_max_amount'])){ ?>
		<div class="cmd_max">
			<div class="threshold">
				Seuil de quantité: <span><?php echo $args['_cmd_max_amount']; ?></span>
			</div>
			<p class="message">En cas d'une commande de quantité supérieure à ce seuil, le délais de fabrication sera rallongé.</p>
		</div>
	<?php } ?>
	<?php
}
